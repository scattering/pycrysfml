...
!!-- Data file reading --!!
Subroutine Read_Powder_Data(datafile,Instrument,Num)
	!---- Arguments ----!
	character(len=*),           intent(in)    :: datafile
	character(len=*),           intent(in)    :: Instrument
	type(Powder_Numor_Type) :: Num
	PRINT *, datafile
	PRINT *, 'Instrument: '
	PRINT *, Instrument
	Call Read_Numor(datafile, Instrument, Num, .false.)
	PRINT *, Num%Instrm
END Subroutine Read_Powder_Data
!!-- debug functions --!!
