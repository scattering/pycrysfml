...
class SpaceGroup(Structure):
    ...
    def __init__(self, groupName=None):
        if (groupName != None):
            ...
            print "__cfml_crystallographic_symmetry_MOD_set_spacegroup"
...
class CrystalCell(Structure):
    ...
    def setCell(self, length, angle):
        print "__cfml_crystal_metrics_MOD_set_crystal_cell"
...
class Atom(Structure):
    ...
    def __init__(self, *args):
        ...
        if (len(args) == 6):
            print "__cfml_atom_typedef_MOD_init_atom_type"
...
class AtomList(Structure):
    ...
    def __init__(self, atoms=None, magnetic=False):
        ...
        if (atoms != None):
            print "__cfml_atom_typedef_MOD_allocate_atom_list"
...
class FileList(Structure):
    ...
    def __init__(self, filename):
        print "__cfml_io_formats_MOD_file_to_filelist"
...
def calcS(cell, hkl):
    if isSequence(hkl[0]):
        ...
        # single hkl
        print "__cfml_reflections_utilities_MOD_hs_r"
...
def readInfo(filename):
    print "__cfml_io_formats_MOD_readn_set_xtal_structure_split"
...
def readMagInfo(filename):
    print "__cfml_magnetic_symmetry_MOD_readn_set_magnetic_structure"
...
def getMaxNumRef(sMax, volume, sMin=0.0, multip=2):
    print "__cfml_reflections_utilities_MOD_get_maxnumref"
...
def hklGen(spaceGroup, cell, sMin, sMax, getList=False, xtal=False):
    ...
    if (not getList):
        ...
        if xtal:
            ...
            print "__cfml_reflections_utilities_MOD_hkl_gen_sxtal_reflection"
            ...
            # powder reflections
            print "__cfml_reflections_utilities_MOD_hkl_uni_reflection"
        ...
        if xtal:
            print "__cfml_reflections_utilities_MOD_hkl_gen_sxtal_list"
            ...
            print "__cfml_reflections_utilities_MOD_hkl_uni_refllist"
...
def satelliteGen(cell, symmetry, sMax):
    print "__cfml_magnetic_structure_factors_MOD_gen_satellites"
...
def calcStructFact(refList, atomList, spaceGroup, wavelength):
    print "__cfml_structure_factors_MOD_init_calc_strfactors"
    ...
    print "__cfml_structure_factors_MOD_calc_strfactor"
...
def calcMagStructFact(refList, atomList, symmetry, cell):
    print "__cfml_magnetic_structure_factors_MOD_init_mag_structure_factors"
    ...
    print "__cfml_magnetic_structure_factors_MOD_mag_structure_factors"
    ...
    print "__cfml_magnetic_structure_factors_MOD_calc_mag_interaction_vector"
...
def diffPattern(infoFile=None, backgroundFile=None, wavelength=1.5403,
    ...
    if plot:
        plotPattern(gaussians, background, observedData[0], observedData[1],
                    ttMin, ttMax, ttStep, exclusions, labels=None)
        pylab.show()
    if saveFile:
...
#        else:
    ...
    def addMagAtom(self, magAtom, symmetry):
        ...
        for i in xrange(self.numVectors):
            self.coeffs[i] = Parameter(1, #self.magAtom.basis[0][i],
