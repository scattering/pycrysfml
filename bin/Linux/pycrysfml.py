...
def FortFuncs_set_psd(dist = None, cg = None, ag = None, nh = None, nv = None, 
    ip = None):
...
def FortFuncs_init_refcodes(fatom = None, fmatom = None, mag_dom = None, molcrys = None, 
    molec = None, model = None):
