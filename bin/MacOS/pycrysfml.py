...
def FortFuncs_set_magnetic_space_group(symb, setting, mspg, parent=None, mcif=None, keepd=None):
    return _pycrysfml.FortFuncs_set_magnetic_space_group(symb, setting, mspg, parent, mcif, keepd)
